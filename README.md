...
| ruby/ruby:rdoc/trunk/{ClassName} | cache.ruby-lang.org tarball → haiku JP 翻訳 |
...
└── ruby-rdoc-collector/                # ruby/ruby RDoc JP 翻訳（cache.ruby-lang.org tarball）
```
...
| [bash0C7/ruby-rdoc-collector](https://github.com/bash0C7/ruby-rdoc-collector) | `ruby_rdoc_collector` | ruby/ruby RDoc JP 翻訳 |
